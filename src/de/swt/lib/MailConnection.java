...
public class MailConnection {
	...
	public void sendMail(String empfaengerAdresse, String betreff, String text) {
		...
		try {
			...
			msg.setRecipients(Message.RecipientType.TO, InternetAddress.parse(empfaengerAdresse, false));
	...
	static class MailAuthenticator extends Authenticator {
		...
		/*
		 * Diese Methode gibt ein neues PasswortAuthentication Objekt zurÃ¼ck.
		 *
		 * 
		 */
